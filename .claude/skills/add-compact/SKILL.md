...
1. Start Halo in dev mode: `npm run dev`
...
```bash
git clone <your-fork> /tmp/halo-test
cd /tmp/halo-test
...
- **No config file.** Halo's philosophy is customization through code changes, not configuration sprawl.
