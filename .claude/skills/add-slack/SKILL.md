...
This skill adds Slack support to Halo, then walks through interactive setup.
...
>
> The JID format for Halo is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.halo`
