---
name: add-discord
description: Add Discord bot channel integration to Halo.
---

# Add Discord Channel

This skill adds Discord support to Halo, then walks through interactive setup.
...
4. Service is running: `launchctl list | grep halo`
...
- @mention translation (Discord `<@botId>` → Halo trigger format)
