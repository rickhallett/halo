...
| `SVC.SHUT.01` | `S2` | Shutdown abandons active containers and startup cleanup kills survivors, dropping in-flight responses during restarts. | `src/index.ts:511-520`, `src/group-queue.ts:347-363`, `src/container-runtime.ts:103-127`, `~/.config/systemd/user/halo.service:5-14` |
