...
**Goal:** Build a Go CLI binary that manages atomic memory notes for Halo agents — schema-validated writes, hash-verified index, scripted pruning.
...
cd tools/memctl
go mod init github.com/rickhallett/halo/tools/memctl
```
...
import "github.com/rickhallett/halo/tools/memctl/cmd"
...
var rootCmd = &cobra.Command{
	Use:   "memctl",
	Short: "Halo memory governance CLI",
	Long: `memctl manages atomic memory notes for Halo agents.
...
```
Expected: Help text with "Halo memory governance CLI"
...
import (
	...
	"github.com/rickhallett/halo/tools/memctl/internal/config"
	"github.com/rickhallett/halo/tools/memctl/internal/index"
	"github.com/rickhallett/halo/tools/memctl/internal/note"
	"github.com/spf13/cobra"
)
...
import (
	...
	"github.com/rickhallett/halo/tools/memctl/internal/config"
	"github.com/rickhallett/halo/tools/memctl/internal/index"
	"github.com/rickhallett/halo/tools/memctl/internal/prune"
	"github.com/spf13/cobra"
)
...
**Files:**
- Create: `tools/memctl/memctl.yaml` (default config for Halo)
